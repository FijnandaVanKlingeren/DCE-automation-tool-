...
newdata = data.frame(
  ...
  "survey_questions"=  intake.data$survey_opties,
...
att16 = c("0-10 euro", "10-30 euro", "30-50 euro")
att17 = c("bezorgservice of zelf ophalen", "alleen zelf ophalen")
att18 = c("externe inkoop", "geen externe inkoop")
att19 = c("alle filialen hebben hetzelfde organisatiemodel", "verschillende filialen hebben verschillende organisatiemodellen")
...
att23 = c("zorgprofessionals in vaste dienst van de organisatie", 
          "zorgprofessionals in vaste dienst en taken uitgevoerd door leden",
          "taken uitgevoerd door leden")
att24 = c("ouderen", "mensen met een beperking", "geen specifieke doelgroep")
att25 = c("bepaald aantal jaren lidmaatschap", "éénmalige vergoeding om hulp te ontvangen", "geen specifieke eisen")
att26 = c("worden uitbesteed aan externe zorg providers", "worden gedaan door de organisatie zelf")
att27 = c("iedereen kan lid worden", "selectieve procedure om lid te worden")
...
att23_name = "De uitvoering van zorg"
att24_name = "Doelgroep"
att25_name = "Condities voor het ontvangen van hulp"
att26_name = "Zorgtaken"
att27_name = "Lidmaatschap voorwaarden"
                                                                                     ...
                                                                                     ifelse(question == "Heeft u een elektrische auto", "car",
                                                                                            ifelse(question == "Heeft u een (hybride) warmtepomp", "heatpump",
                                                                                                   ifelse(question == "Heeft u zonnepanelen?", "solarpanels",
                                                                                                          ifelse(question == "Ontvangt u op dit moment zorg vanuit het burgercollectief?", "care", NA))))))))))))
...
write.csv(survey_questions, "C:/Users/Fijnanda/Dropbox/RSM postdoc/DCE project/app/DKE_case/survey_questions.csv", row.names = FALSE)
...
write.csv(DKE_design.oa$design, "[yourpath]/DKE_design_oa.csv")
#-------------------------------------------------------------------------------
...
oa_csv <- read.csv("[yourpath]/DKE_design_oa.csv")
