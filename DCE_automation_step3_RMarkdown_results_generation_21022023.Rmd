...
![](ck_logo.png) 
```{r, include=FALSE}
# Fill above the path to the collectieve kracht logo
```
...
![Collectieve Kracht](C:/Users/Fijnanda/Dropbox/RSM postdoc/DCE project/app/rcode/ck_logo.png) 
